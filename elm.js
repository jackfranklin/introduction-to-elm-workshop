		...
		if (_p0._0.ctor === 'Ok') {
			...
			var status = function () {
				...
				switch (_p1.ctor) {
					...
					case 'BadUrl':
						return A2(_elm_lang$core$Basics_ops['++'], 'Invalid test URL: ', _p1._0);
					case 'BadPayload':
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Elm Workshop'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
						...
						_0: _elm_lang$html$Html_Attributes$style(
							{
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'padding', _1: '48px'},
										_1: {ctor: '[]'}
									}
								}
							}),
...
var _user$project$Main$initialModel = {status: 'Verifying setup...'};
...
var _user$project$Main$searchFeed = function () {
	var url = 'http://github-proxy-api.herokuapp.com/users/jackfranklin';
	return A2(
...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{
		...
		init: {ctor: '_Tuple2', _0: _user$project$Main$initialModel, _1: _user$project$Main$searchFeed},
